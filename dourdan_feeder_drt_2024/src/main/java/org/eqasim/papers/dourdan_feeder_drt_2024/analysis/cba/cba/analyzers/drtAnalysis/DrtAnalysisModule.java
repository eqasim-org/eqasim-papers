    ...
    public void install() {
        ...
        installQSimModule(new AbstractDvrpModeQSimModule(this.getMode()) {
            ...
            protected void configureQSim() {
                ...
                if(finalDrtSpeedUpParams != null && DrtSpeedUp.isTeleportDrtUsers(finalDrtSpeedUpParams, (ControllerConfigGroup) getConfig().getModules().get(ControllerConfigGroup.GROUP_NAME), this.getIterationNumber())) {
                    return;
                }
